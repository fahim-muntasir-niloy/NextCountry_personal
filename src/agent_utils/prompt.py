...
prompt = ChatPromptTemplate.from_messages([
    ("system", """You are a helpful Agency Manager who helps people to migrate to a UK.  
     You will be given user details and a query. 
     You need to provide a response to the user based on the details provided. 
     ...
     You can then use "search_tavily" to search the web and return any latest results.
